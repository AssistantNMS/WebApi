...
namespace NMS.Assistant.Api.Migrations
{
    ...
    [Migration("20200415103019_AddSensitiveInfoFlagToFeedbackQuestion")]
    partial class AddSensitiveInfoFlagToFeedbackQuestion
    {
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.GuideDetail", b =>
                {
                    b.HasOne("NMS.Assistant.Persistence.Entity.GuideMeta", "GuideMeta")
                        .WithOne("Detail")
                        .HasForeignKey("NMS.Assistant.Persistence.Entity.GuideDetail", "Guid")
