...
namespace NMS.Assistant.Api.Migrations
{
    ...
    [Migration("20230204111755_AddGenericUpdateTable")]
    partial class AddGenericUpdateTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.CommunityMissionProgress", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CommunityMissionGuid")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CommunityMissionGuid");

                    b.ToTable("CommunityMissionsProgress");
                });

            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.CommunityMissionRecord", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CommunityMissionRecords");
                });

            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.CommunityMissionRecordTier", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FallbackImgUrl")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("FallbackTitle")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("CommunityMissionRecordTiers");
                });
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.Expedition", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.MonitorRecord", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.SteamUpdateEvent", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.UpdateEvent", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.CommunityMissionProgress", b =>
                {
                    b.HasOne("NMS.Assistant.Persistence.Entity.CommunityMissionRecord", "CommunityMission")
                        .WithMany("Progress")
                        .HasForeignKey("CommunityMissionGuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("ForeignKey_Progress_CommunityMission");

                    b.Navigation("CommunityMission");
                });
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.GuideMetaGuideDetail", b =>
                {
                    ...
                    b.Navigation("GuideDetail");

                    b.Navigation("GuideMeta");
                });
            ...
            modelBuilder.Entity("NMS.Assistant.Persistence.Entity.GuideDetail", b =>
                {
                    b.Navigation("GuideMetaGuideDetails");
                });
